...
import com.crud.persona.servicios.PersonaService;
...
public class PersonaRest {
	...
	private ResponseEntity<List<Persona>> getPersonaNombre (@PathVariable("id") Sort id){
		return ResponseEntity.ok(personaService.findAll(id));
	}
